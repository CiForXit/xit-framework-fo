  ...
  return (
    <S.CreateTicketFormContainer>
      ...
      <FormItem
        ...
        <InputOnlyNumber inputName="ticketMaxCntPerPerson" {...FormInputs.maxCntPerPerson} />
      </FormItem>
      <FormItem
        label={TICKET_FORM_SALES_DATE}
        labelExplanation={TICKET_FORM_SALES_DATE_LABEL}
        captionContent={TICKET_FORM_SALES_DATE_CAPTION}>
        <DateTimePicker range={true} firstLabelName="시작" secondLabelName="종료" {...FormInputs.salesDate} />
      </FormItem>
      <FormItem
        ...
        <DateTimePicker range={false} firstLabelName="환불 마감일" {...FormInputs.refundDate} />
      </FormItem>
    </S.CreateTicketFormContainer>
  );
}
