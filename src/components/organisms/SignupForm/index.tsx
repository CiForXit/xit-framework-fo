...
const SignupForm =({FormInputs, Button}: Props): React.ReactElement => {
  return (
    <S.SignUpFormContainer>
      <FormInput {...FormInputs.email} />
      <S.NameContainer>
        <FormInput {...FormInputs.lastName} data-testid={'signupform-lastname'} />
        <FormInput {...FormInputs.firstName} data-testid={'signupform-firstname'} />
      </S.NameContainer>
      <FormInput {...FormInputs.phoneNumber} data-testid={'signupform-phonenumber'} />
      <S.BtnWrapper>
